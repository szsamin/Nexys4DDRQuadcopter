...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "FREQ_WIDTH"
  ipgui::add_param $IPINST -name "CLK_FREQ_HZ"
...
proc update_PARAM_VALUE.DUTY_WIDTH { PARAM_VALUE.DUTY_WIDTH } {
	# Procedure called to update DUTY_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.DUTY_WIDTH { PARAM_VALUE.DUTY_WIDTH } {
	# Procedure called to validate DUTY_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.DUTY_WIDTH { MODELPARAM_VALUE.DUTY_WIDTH PARAM_VALUE.DUTY_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.DUTY_WIDTH}] ${MODELPARAM_VALUE.DUTY_WIDTH}
}
